...
# List the folders to be copied (assuming they are direct children of the source directory)
...
copy_files_to_new_folders <- function(df, index) {
  # Assuming df$folder indicates the correct original folder for each file
