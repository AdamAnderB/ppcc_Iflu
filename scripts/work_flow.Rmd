...
```{r}
comp_targ<-s_exp1_data_all%>%filter(time_rounded>200&time_rounded<699)%>%
  mutate(syllable=case_when(stress_play=="Penultimate" & time_rounded<penn_times[1]~1,
                            ...
                            stress_play=="Anit-penultimate" & time_rounded<anti_times[1]~1,
                            stress_play=="Anit-penultimate" & time_rounded>anti_times[1] &
                              time_rounded<mean(anti_times[2],anti_times[3]) ~2,
                            stress_play=="Anit-penultimate" & time_rounded>anti_times[3]~3))
