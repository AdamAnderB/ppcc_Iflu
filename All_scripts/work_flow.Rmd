...
combined_plot_2 <- plot_grid(plot1,plot2, pen_anti_model, ncol = 1,rel_heights = c(2,2,2))+
  draw_label("Estimated Coefficients                                   Antepenultimate                                   Penultimate ", x = 0.02, y = 0.5, angle = 90, size = 14)
