...
raw_acoustics<-acoustic_data_longer %>%
  ...
  geom_smooth(aes(x = syllable,  y = values, color = stress_play, 
                  group = interaction(stress_play, type)), method = "lm", se = FALSE,size=1) +
  geom_smooth(aes(x = syllable,  y = values, 
                  group = interaction(stress_play, type)), color = "white",method = "lm", se = FALSE,size=1,linetype="dotted") +
  ...
  labs(title = "          Vowel 1                Vowel 2                                     Vowel 1                Vowel 2",
       x = "", y = "",color = "Type")+
  theme(legend.position = "bottom",
