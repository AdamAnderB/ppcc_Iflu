...
form supply_arguments
	sentence input_directory  /Users/adambramlett/scripts/all_Mandarin_speakers/fv3
	sentence output_directory /Users/adambramlett/scripts/all_Mandarin_speakers/fv3_data
...
Create Strings as file list... list 'input_directory$'
...
for i to numSelected 
	...
	select Table table_word_'i'
	Write to table file... 'output_directory$'/'fileName$'.csv
endfor